...
def _extract_ebay_attributes(product: dict[str, Any]) -> dict[str, Any]:
...
def parse_ebay_product(zyte_data: dict[str, Any], url: str) -> dict[str, Any]:
    ...
    attributes = _extract_ebay_attributes(product)
    ...
    return {
        ...
        "product_id": clean_text(product.get("sku") or product.get("mpn") or product.get("gtin")),
        "sku": clean_text(product.get("sku") or product.get("mpn") or product.get("gtin")),
        "brand": get_brand_name(product),
        "price": price["price"],
